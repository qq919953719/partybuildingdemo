...
public abstract class JZVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public static int LAND_ORIENTATION = ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE;
...
//        JZUtils.setRequestedOrientation(context, FULLSCREEN_ORIENTATION);
        JZUtils.setRequestedOrientation(context, LAND_ORIENTATION);
...
//        JZUtils.setRequestedOrientation(getContext(), FULLSCREEN_ORIENTATION);
        JZUtils.setRequestedOrientation(getContext(), LAND_ORIENTATION);
        ViewGroup vp = (ViewGroup) (JZUtils.scanForActivity(getContext()))//.getWindow().getDecorView();
                .findViewById(Window.ID_ANDROID_CONTENT);
        View old = vp.findViewById(R.id.jz_fullscreen_id);
        if (old != null) {
        ...
        try {
            ...
            jzVideoPlayer.setIsLiveStream(isLiveStream);
