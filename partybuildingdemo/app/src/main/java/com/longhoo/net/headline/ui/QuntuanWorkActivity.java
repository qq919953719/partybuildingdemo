...
public class QuntuanWorkActivity extends BaseActivity implements HttpRequestView, OnRefreshLoadmoreListener, HeaderAndFooterWrapper.OnItemClickListener {
    ...
    private String url = Consts.BASE_URL + "/News/public_jobnews";
    private int mPage = 1;

    @Override
    protected int getContentId() {
        return R.layout.activity_quntuan_work;
    }
    ...
    public void onRefreshSuccess(String response) {
        ULog.e(Consts.TAG, "群团工作:" + response);
        //处理数据
    ...
    public void onLoadMoreSuccess(String response) {
        ULog.e(Consts.TAG, "群团工作:" + mPage + ":" + response);
        //处理数据
