...
public class NoteEditActivity extends BaseActivity implements PostGridAdapter.onAddPicClickListener, PostGridAdapter.OnItemClickListener {
        ...
        OkHttpUtil.getInstance().doAsyncMultiUpload(url, params, list, "uploads[]", new OkHttpCallback() {
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    ToastUtils.getInstance().showToast(NoteEditActivity.this, msg);
                    ...
                    e.printStackTrace();
                    ToastUtils.getInstance().showToast(NoteEditActivity.this, "服务器异常，提交失败~");
                }
            ...
            public void onFailure(String errorMsg) {
                ToastUtils.getInstance().showToast(NoteEditActivity.this, "网络异常，提交失败~");
                if (isFinishing()) {
                    return;
                }
                tvSignUp.setText("立即提交");
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (!TextUtils.equals(code, "0")) {
                        ToastUtils.getInstance().showToast(NoteEditActivity.this, "获取数据失败~");
                        return;
                    }
                    ...
                    e.printStackTrace();
                    ToastUtils.getInstance().showToast(NoteEditActivity.this, "服务器异常~");
                }
            }

            @Override
            public void onFailure(String errorMsg) {
                ToastUtils.getInstance().showToast(NoteEditActivity.this, "网络异常~");
            }
        });
    }
