...
public class SupervisionAndCheckAdapter extends BaseAdapter {
    private Context context;
    private List<PartyTabBean> dataList;

    public SupervisionAndCheckAdapter(Context context, List<PartyTabBean> dataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_supervision_and_check, viewGroup, false);
