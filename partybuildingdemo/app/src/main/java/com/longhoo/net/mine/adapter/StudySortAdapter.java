...
public class StudySortAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<StudySortBean.DataBean.ListBean.RankListBean> list;
    private String tag;

    public StudySortAdapter(Context context, List<StudySortBean.DataBean.ListBean.RankListBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof HeadlineViewHolder) {
            StudySortBean.DataBean.ListBean.RankListBean bean = list.get(position);
            ...
            ((HeadlineViewHolder) holder).tvItemscore.setText(list.get(position).getCtime() + "");
        }
    }
