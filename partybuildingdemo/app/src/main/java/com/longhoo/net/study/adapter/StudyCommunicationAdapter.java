...
public class StudyCommunicationAdapter extends BaseAdapter {
    private Context context;
    private List<PartyTabBean> dataList;

    public StudyCommunicationAdapter(Context context, List<PartyTabBean> dataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_study_communication, viewGroup, false);
