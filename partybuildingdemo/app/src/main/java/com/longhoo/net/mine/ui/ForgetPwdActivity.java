...
//        toolbar.setRight(R.drawable.turn_right);
    ...
    private void doRequestCode() {
        ...
        String url = Consts.BASE_URL + "/Index/public_backpwmsg";
        ...
        OkHttpUtil.getInstance().doAsyncPost(url, params, new OkHttpCallback() {
            ...
            public void onSuccess(String response) {
                ULog.e("ck","code:"+response);
                try {
                    JSONObject jsonObject = new JSONObject(response);
                    ToastUtils.getInstance().showToast(ForgetPwdActivity.this, jsonObject.optString("msg"));
                    ...
                    e.printStackTrace();
                    ToastUtils.getInstance().showToast(ForgetPwdActivity.this, "服务器异常~");
                    mCountDownTime = 1;
                }
            }
            ...
            public void onFailure(String errorMsg) {
                ToastUtils.getInstance().showToast(ForgetPwdActivity.this, "网络错误~");
                mCountDownTime = 1;
            }
        });
    }
    ...
    private void doCommit() {
        ...
        String oldPwd = edtPwd.getText().toString().trim();
 ...
 */
        ...
        String url = Consts.BASE_URL + "/Index/public_backpwd";
