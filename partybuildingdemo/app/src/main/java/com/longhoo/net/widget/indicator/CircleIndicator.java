package com.longhoo.net.widget.indicator;
...
public class CircleIndicator extends View {
   ...
   // private int mStrokeColor;
    ...
    private final int DEFAULT_INDICATOR_STROKE_WIDTH = 0;
    private final int DEFAULT_INDICATOR_STROKE_COLOR = Color.WHITE;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        //mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.CircleIndicator_ci_stroke_width,DEFAULT_INDICATOR_STROKE_WIDTH);
        //mStrokeColor = typedArray.getColor(R.styleable.CircleIndicator_ci_stroke_color,DEFAULT_INDICATOR_STROKE_COLOR);
    ...
    private void trigger(int position, float positionOffset) {
        ...
        //ULog.e("CircleIndicator", "onPageScrolled()" + position + ":" + positionOffset);
        requestLayout();
        invalidate();
    }
