...
public class PartybuildModelActivity extends BaseActivity implements HttpRequestView, OnRefreshLoadmoreListener, HeaderAndFooterWrapper.OnItemClickListener, PartybuildxfAdapter.OnSupportClickListener {
        ...
        OkHttpUtil.getInstance().doAsyncPost(mSupportUrl, params, new OkHttpCallback() {
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    ToastUtils.getInstance().showToast(PartybuildModelActivity.this, msg);
                } catch (JSONException e) {
                    e.printStackTrace();
                    ToastUtils.getInstance().showToast(PartybuildModelActivity.this, "数据异常~");
                }
            }

            @Override
            public void onFailure(String errorMsg) {
                ToastUtils.getInstance().showToast(PartybuildModelActivity.this, "网络异常~");
            }
        });
    }
