...
import com.longhoo.net.manageservice.ui.DemocraticLifeActivity;
 ...
 * 我的党费
 */
public class PartyFeeActivity extends BaseActivity implements OnRefreshLoadmoreListener, HttpRequestView {
    ...
    private List<PartyFeeBean.DataBean> dataList = new ArrayList<>();
    PartyFeeAdapter adapter;
    ...
    protected void initViews() {
        ...
        adapter = new PartyFeeAdapter(this, dataList);
...
//        setSupportActionBar(toolbar);
    ...
    public void onRefreshSuccess(String response) {
        //处理数据
        List<PartyFeeBean.DataBean> tempList = null;
        Gson gson = new Gson();
        try {
            PartyFeeBean customItemBean = gson.fromJson(response, PartyFeeBean.class);
    ...
    public void onLoadMoreSuccess(String response) {
        List<PartyFeeBean.DataBean> tempList2 = null;
        Gson gson = new Gson();
        try {
            PartyFeeBean customItemBean = gson.fromJson(response, PartyFeeBean.class);
            String code = customItemBean.getCode();
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        ...
        requestPresenter.doHttpData(Consts.BASE_URL + "/fee/my_fee", Consts.REQUEST_METHOD_POST, Consts.REQUEST_LOADMORE, params);
    }
    ...
    public void onRefresh(RefreshLayout refreshlayout) {
        ...
        params.put("uid", EnterCheckUtil.getInstance().getUid_Token()[0]);
        params.put("token", EnterCheckUtil.getInstance().getUid_Token()[1]);
        requestPresenter.doHttpData(Consts.BASE_URL + "/fee/my_fee", Consts.REQUEST_METHOD_POST, Consts.REQUEST_REFRESH, params);
