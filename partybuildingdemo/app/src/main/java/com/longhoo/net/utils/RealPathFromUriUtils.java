...
public class RealPathFromUriUtils {
    ...
    public static String getFilePathFromURI(Context context, Uri contentUri) {
        ...
        if (!TextUtils.isEmpty(fileName)) {
            File copyFile = null;
            if (fileName.contains("image") || fileName.contains("images") || (!fileName.contains("."))) {
                copyFile = new File(rootDataDir + File.separator + fileName + ".jpg");
            } else {
                copyFile = new File(rootDataDir + File.separator + fileName);
            }
