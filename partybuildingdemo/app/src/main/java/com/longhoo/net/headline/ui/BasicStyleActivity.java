...
public class BasicStyleActivity extends BaseActivity implements HttpRequestView, OnRefreshLoadmoreListener, HeaderAndFooterWrapper.OnItemClickListener {
    ...
    private String url = Consts.BASE_URL + "/News/public_countrynews";
    private int mPage = 1;
    private String uid = "0";

    @Override
    protected int getContentId() {
        return R.layout.activity_basic_style;
    }
    ...
    protected void initViews() {
        ...
        adapter = new CustomItemAdapter(this, dataList);
    ...
    public void onRefreshSuccess(String response) {
        ULog.e(Consts.TAG, "基层风采:" + response);
        //处理数据
    ...
    public void onLoadMoreSuccess(String response) {
        ULog.e(Consts.TAG, "基层风采:" + mPage + ":" + response);
        //处理数据
