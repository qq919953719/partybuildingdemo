...
public class CurrentAffairsAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<CurrentAffairsBean.DataBean> list;
    private String type;

    public CurrentAffairsAdapter(Context context, List<CurrentAffairsBean.DataBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof HeadlineViewHolder) {
            CurrentAffairsBean.DataBean bean = list.get(position);
            ((HeadlineViewHolder) holder).itemTvTitle.setText(bean.getTitle() + "");
            ((HeadlineViewHolder) holder).itemTime.setText(bean.getAdd_time() + "");
            ...
            if (!TextUtils.isEmpty(bean.getThumbnail())) {
                ...
                GlideManager.getInstance().load(context, bean.getThumbnail(), ((HeadlineViewHolder) holder).itemIvThumb);
            } else {
