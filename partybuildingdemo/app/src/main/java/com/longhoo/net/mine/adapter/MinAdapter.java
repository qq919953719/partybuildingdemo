...
public class MinAdapter extends BaseAdapter {
    ...
    public MinAdapter(Context context, List<PartyTabBean> dataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_min_home, viewGroup, false);
            holder = new ViewHolder();
            holder.ivThumb = (ImageView) view.findViewById(R.id.iv_thumb);
            holder.tvTitle = (TextView) view.findViewById(R.id.tv_title);
            holder.msgDot = view.findViewById(R.id.msg_dot);
            view.setTag(holder);
        } else {
