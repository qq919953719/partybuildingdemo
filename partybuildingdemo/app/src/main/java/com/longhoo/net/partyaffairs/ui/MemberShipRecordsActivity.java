...
import com.longhoo.net.partyaffairs.adapter.MemberShipRecordsAdapter;
...
public class MemberShipRecordsActivity extends BaseActivity implements HttpRequestView, OnRefreshLoadmoreListener,HeaderAndFooterWrapper.OnItemClickListener {
    ...
    private MemberShipRecordsAdapter adapter;
    private HeaderAndFooterWrapper wrapperAdapter;
    private List<MemberShipRecordsBean.DataBean> dataList = new ArrayList<>();
    private HttpRequestPresenter requestPresenter;
    private String url = Consts.BASE_URL + "/Application/myPayMemHis";
    private int mPage = 1;

    @Override
    protected int getContentId() {
        return R.layout.activity_member_ship_records;
    }
    ...
    protected void initViews() {
        ...
        adapter = new MemberShipRecordsAdapter(this, dataList);
    ...
    public void onRefreshSuccess(String response) {
        ULog.e(Consts.TAG, "我的党费:" + response);
        //处理数据
        List<MemberShipRecordsBean.DataBean> tempList = null;
        Gson gson = new Gson();
        try {
            MemberShipRecordsBean recordsBean = gson.fromJson(response, MemberShipRecordsBean.class);
    ...
    public void onLoadMoreSuccess(String response) {
        ULog.e(Consts.TAG, "我的党费:" + mPage + ":" + response);
        //处理数据
        List<MemberShipRecordsBean.DataBean> tempList2 = null;
        Gson gson = new Gson();
        try {
            MemberShipRecordsBean recordsBean = gson.fromJson(response, MemberShipRecordsBean.class);
            String code = recordsBean.getCode();
